...
import { ArrowLeft, ClipboardCheck, Lock, RefreshCw } from "lucide-react";
...
export default function ClinicalReview() {
  ...
  const selectPatient = async (patient) => {
    ...
    try {
      const { data } = await api.get(`/clinical/patients/${patient.id}/records`);
